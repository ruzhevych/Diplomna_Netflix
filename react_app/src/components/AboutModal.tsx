...
const AboutModal: React.FC<MovieModalProps> = ({ movie, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4 animate-fadeIn">
      <div className="bg-[#191716] rounded-lg max-w-2xl mx-auto w-full max-h-[90vh] overflow-y-auto relative shadow-2xl animate-slideInUp">
        ...
        <div className="p-8 relative z-10 -mt-24 md:-mt-36">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <button
              ...
              className="bg-[#C4FF00] text-black px-6 py-3 rounded-lg hover:bg-lime-500 transition flex items-center justify-center gap-2 font-bold"
            >
              <FaPlay />
