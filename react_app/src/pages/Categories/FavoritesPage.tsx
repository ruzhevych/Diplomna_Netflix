    ...
    useEffect(() => {
        ...
        const loadDetails = async () => {
            ...
            try {
                ...
                toast.error("Помилка завантаження деталей улюбленого 😢", err?.data?.message);
            } finally {
    ...
    return (
        <div className="bg-black text-white min-h-screen">
            ...
            <div className="px-8 py-10 max-w-[1600px] mx-auto">
                ...
                {isError && <p className="text-red-500">Помилка завантаження улюбленого</p>}
                {!isLoading && items.length === 0 && <p className="text-gray-400">Улюблених ще немає 😢</p>}
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6">
                    {items.map((movie) => (
                        ...
                        >
                            ...
                            <div
                                className="absolute inset-x-0 bottom-0 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-in-out bg-black/90 p-3 rounded-t-lg">
