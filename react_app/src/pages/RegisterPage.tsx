...
const RegisterPage = () => {
  ...
  const [isAgreed, setIsAgreed] = useState(false); // Новий стан для прапорця
    ...
    >
      ...
      <div className="flex flex-1 items-center justify-center">
        <div className="bg-black/80 py-8 px-10 w-full max-w-md">
          <h2 className="text-white text-3xl font-bold mb-6 py-2 text-left">Sign Up</h2>
          ...
          <form onSubmit={handleNext} className="space-y-4">
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="terms-checkbox" className="ml-3 text-white font-semibold text-md">
                I agree to the <a href="/terms" className="text-white no-underline hover:underline">Terms of Service</a> and <a href="/privacy" className="text-white no-underline hover:underline">Privacy Policy</a>
              </label>
            </div>
