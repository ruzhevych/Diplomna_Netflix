...
// ✅ 1. Імпорт нового компонента модального вікна
...
const ProfilePage = () => {
  ...
  // ✅ 2. Стан для керування видимістю модального вікна виходу
  ...
  // ✅ 3. Функція, що містить оригінальну логіку виходу
  const handleConfirmLogout = () => {
    localStorage.removeItem("accessToken");
    navigate("/login");
    window.location.reload();
    setIsLogoutModalOpen(false); // Закриваємо модальне вікно
  };
...
          )}
      ...
      {/* ✅ 5. Рендер модального вікна підтвердження виходу */}
      <LogoutConfirmModal
